    ...
    let panel = $(
        `<div class="panel panel-default panel-margin">
            <div id="headline-panel" class="panel-heading clearfix">
              ...
              <button type="button" class="btn btn-warning pull-right delete">Delete From Saved</button>
              <button type="button" class="btn btn-secondary pull-right notes">Article Notes</button>
